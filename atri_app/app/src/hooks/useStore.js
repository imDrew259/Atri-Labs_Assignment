  ...
  "Home": {
    ...
    "Image1": {
      "custom": {
        ...
        "src": "/app-assets/right-arrow(1).png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image16": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot%20from%202022-12-26%2019-36-26.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image17": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Screenshot%20from%202022-12-26%2019-35-01.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox80": {
      "custom": {
        "text": "Logo design trend to not follow in 2021"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox69": {
      "custom": {
        "text": "Top 6 free website mockup tool 2021"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox76": {
      "custom": {
        "text": "Design tips for designers, that cover evrything you need."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox145": {
      "custom": {
        "text": "MSC (Human Computer Construction)"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox155": {
      "custom": {
        "text": "What if need help after completing project?"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox156": {
      "custom": {
        "text": "What metrices do you use to measure metrices?"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox158": {
      "custom": {
        "text": "What is the typical timeline for ?"
      },
      "callbacks": {
        "onClick": [
          {
